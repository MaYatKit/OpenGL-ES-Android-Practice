 ...
 * Created by yijie.ma on 2019/1/23.
 */
class Mallet constructor(radius: Float, height: Float, numPointAroundMallet: Int) {
    ...
    init {
        val genratedData = ObjectBuilder.createMallet(Geometry.Point(0f, 0f, 0f), radius, height, numPointAroundMallet)
        this.radius = radius
        this.height = height
