...
public class Table {
    ...
    public void bindData(ShaderProgram.TextureShaderProgram textureShaderProgram) {
        ...
        mVertexArray.setVertexAttribPointer(POSTION_COMPONENT_COUNT, textureShaderProgram.getaTextureCoordinatesLocation2(), TEXTURE_COORDINATES_COMPONENT_COUNT, STRIDE);
